...
public final class VectorStoresImpl {
     ...
     */
    VectorStoresImpl(AgentsAdministrationClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AgentsAdministrationClientVectorStores to be used by the proxy
    ...
    public Response<BinaryData> listVectorStoresWithResponse(RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.listVectorStoresSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
