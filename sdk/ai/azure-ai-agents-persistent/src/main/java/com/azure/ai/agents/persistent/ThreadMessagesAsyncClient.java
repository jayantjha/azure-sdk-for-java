...
import com.azure.ai.agents.persistent.implementation.ThreadMessagesImpl;
...
/**
 * Initializes a new instance of the asynchronous ThreadMessages type.
 */
@ServiceClient(builder = PersistentAgentsClientBuilder.class, isAsync = true)
public final class ThreadMessagesAsyncClient {

    @Generated
    private final ThreadMessagesImpl serviceClient;

    /**
     * Initializes an instance of ThreadMessagesAsyncClient class.
     *
     * @param serviceClient the service client implementation.
     */
    @Generated
    ThreadMessagesAsyncClient(ThreadMessagesImpl serviceClient) {
