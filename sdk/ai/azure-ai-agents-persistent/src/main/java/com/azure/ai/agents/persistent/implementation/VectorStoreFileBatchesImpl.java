...
public final class VectorStoreFileBatchesImpl {
     ...
     */
    VectorStoreFileBatchesImpl(AgentsAdministrationClientImpl client) {
    ...
    /**
     * The interface defining all the services for AgentsAdministrationClientVectorStoreFileBatches to be used by the
