...
public final class RunsClient {
    ...
    private final RunsClientTracer clientTracer;
     ...
     */
    RunsClient(RunsImpl serviceClient, RunsClientTracer clientTracer) {
    ...
    public ThreadRun createRun(CreateRunOptions options) {
        ...
        ClientTracer.Operation<ThreadRun> operation
            = (arg) -> createRunWithResponse(threadId, createRunRequest, arg).getValue().toObject(ThreadRun.class);
        return clientTracer.traceCreateRunSync(options, operation, requestOptions);
    }
    ...
    public ThreadRun submitToolOutputsToRun(String threadId, String runId, List<ToolOutput> toolOutputs) {
        ...
        ClientTracer.Operation<ThreadRun> operation
            = (arg) -> submitToolOutputsToRunWithResponse(threadId, runId, submitToolOutputsToRunRequest, arg)
                .getValue()
                .toObject(ThreadRun.class);
        return clientTracer.traceSubmitToolOutputsSync(threadId, runId, toolOutputs, operation, requestOptions);
    }
    ...
    public PagedIterable<RunStep> listRunSteps(String threadId, String runId, List<RunAdditionalFieldList> include,
        ...
        ClientTracer.Operation<PagedIterable<RunStep>> operation
            = (arg) -> serviceClient.listRunSteps(threadId, runId, arg)
                .mapPage(bodyItemValue -> bodyItemValue.toObject(RunStep.class));
        return clientTracer.traceListRunStepsSync(threadId, runId, operation, requestOptions);
    }
