...
/**
 * Initializes a new instance of the synchronous AgentsAdministrationClient type.
 */
@ServiceClient(builder = AgentsAdministrationClientBuilder.class)
public final class AgentsAdministrationClient {

    @Generated
    private final AgentsAdministrationClientImpl serviceClient;

    /**
     * Initializes an instance of AgentsAdministrationClient class.
     *
     * @param serviceClient the service client implementation.
     */
    @Generated
    AgentsAdministrationClient(AgentsAdministrationClientImpl serviceClient) {
