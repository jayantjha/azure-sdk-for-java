...
import com.azure.ai.agents.persistent.implementation.PersistentAgentsFilesImpl;
import com.azure.ai.agents.persistent.implementation.models.FileDeletionStatus;
import com.azure.ai.agents.persistent.implementation.models.FileListResponse;
...
/**
 * Initializes a new instance of the asynchronous PersistentAgentsFiles type.
 */
@ServiceClient(builder = PersistentAgentsClientBuilder.class, isAsync = true)
public final class PersistentAgentsFilesAsyncClient {

    @Generated
    private final PersistentAgentsFilesImpl serviceClient;

    /**
     * Initializes an instance of PersistentAgentsFilesAsyncClient class.
     *
     * @param serviceClient the service client implementation.
     */
    @Generated
    PersistentAgentsFilesAsyncClient(PersistentAgentsFilesImpl serviceClient) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<Response<BinaryData>> listFilesInternalWithResponse(RequestOptions requestOptions) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<FileListResponse> listFilesInternal(FilePurpose purpose) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    Mono<FileListResponse> listFilesInternal() {
        // Generated convenience method for listFilesInternalWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return listFilesInternalWithResponse(requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(FileListResponse.class));
