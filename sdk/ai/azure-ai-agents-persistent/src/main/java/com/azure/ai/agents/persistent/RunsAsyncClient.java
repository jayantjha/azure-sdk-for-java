...
public final class RunsAsyncClient {
     ...
     */
    RunsAsyncClient(RunsImpl serviceClient, RunsClientTracer clientTracer) {
    ...
    public Mono<ThreadRun> createRun(CreateRunOptions options) {
        ...
        ClientTracer.Operation<Mono<ThreadRun>> operation
            = (arg) -> createRunWithResponse(threadId, createRunRequest, requestOptions).flatMap(FluxUtil::toMono)
                .map(protocolMethodData -> protocolMethodData.toObject(ThreadRun.class));
        return clientTracer.traceCreateRunAsync(options, operation, requestOptions);
    }
    ...
    public Mono<ThreadRun> submitToolOutputsToRun(String threadId, String runId, List<ToolOutput> toolOutputs) {
        ...
        ClientTracer.Operation<Mono<ThreadRun>> operation
            = (arg) -> submitToolOutputsToRunWithResponse(threadId, runId, submitToolOutputsToRunRequest, arg)
                .flatMap(FluxUtil::toMono)
                .map(protocolMethodData -> protocolMethodData.toObject(ThreadRun.class));
        return clientTracer.traceSubmitToolOutputsAsync(threadId, runId, toolOutputs, operation, requestOptions);
    }
    ...
    public PagedFlux<RunStep> listRunSteps(String threadId, String runId, List<RunAdditionalFieldList> include,
        ...
        ClientTracer.Operation<PagedFlux<RunStep>> operation = (arg) -> {
        ...
        return clientTracer.traceListRunStepsAsync(threadId, runId, operation, requestOptions);
    }
