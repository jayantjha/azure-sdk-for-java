...
public final class ThreadsImpl {
     ...
     */
    ThreadsImpl(AgentsAdministrationClientImpl client) {
    ...
    /**
     * The interface defining all the services for AgentsAdministrationClientThreads to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
