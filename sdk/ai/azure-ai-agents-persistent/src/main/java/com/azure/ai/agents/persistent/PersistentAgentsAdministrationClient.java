...
public final class PersistentAgentsAdministrationClient {
    ...
    public PersistentAgent createAgent(CreateAgentOptions options) {
        ...
        final ClientTracer.Operation<PersistentAgent> operation
            = (arg) -> createAgentWithResponse(createAgentRequest, arg).getValue().toObject(PersistentAgent.class);
        return clientTracer.traceCreateAgentSync(options, operation, requestOptions);
    }
