...
public final class MessagesClient {
     ...
     */
    MessagesClient(MessagesImpl serviceClient, MessagesClientTracer clientTracer) {
    ...
    public ThreadMessage createMessage(String threadId, MessageRole role, BinaryData content) {
        ...
        BinaryData createMessageRequest = BinaryData.fromObject(createMessageRequestObj);
        final ClientTracer.Operation<ThreadMessage> operation
            = (arg) -> createMessageWithResponse(threadId, createMessageRequest, requestOptions).getValue()
                .toObject(ThreadMessage.class);
        return clientTracer.traceCreateMessageSync(threadId, role, content, null, operation, requestOptions);
    }
    ...
    public PagedIterable<ThreadMessage> listMessages(String threadId, String runId, Integer limit, ListSortOrder order,
        ...
        ClientTracer.Operation<PagedIterable<ThreadMessage>> operation
            = (arg) -> serviceClient.listMessages(threadId, arg)
                .mapPage(bodyItemValue -> bodyItemValue.toObject(ThreadMessage.class));
        return clientTracer.traceListMessagesSync(threadId, runId, operation, requestOptions);
    }
    ...
    public PagedIterable<ThreadMessage> listMessages(String threadId) {
        ...
        ClientTracer.Operation<PagedIterable<ThreadMessage>> operation
            = (arg) -> serviceClient.listMessages(threadId, arg)
                .mapPage(bodyItemValue -> bodyItemValue.toObject(ThreadMessage.class));
        return clientTracer.traceListMessagesSync(threadId, null, operation, requestOptions);
    }
