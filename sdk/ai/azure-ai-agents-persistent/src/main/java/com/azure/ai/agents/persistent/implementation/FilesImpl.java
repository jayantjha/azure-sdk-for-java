...
public final class FilesImpl {
     ...
     */
    FilesImpl(AgentsAdministrationClientImpl client) {
    ...
    /**
     * The interface defining all the services for AgentsAdministrationClientFiles to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
