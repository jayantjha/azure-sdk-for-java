...
/**
 * Initializes a new instance of the synchronous PersistentAgentsFiles type.
 */
@ServiceClient(builder = PersistentAgentsClientBuilder.class)
public final class PersistentAgentsFilesClient {

    private static final ClientLogger LOGGER = new ClientLogger(PersistentAgentsFilesClient.class);

    @Generated
    private final PersistentAgentsFilesImpl serviceClient;

    /**
     * Initializes an instance of PersistentAgentsFilesClient class.
     *
     * @param serviceClient the service client implementation.
     */
    @Generated
    PersistentAgentsFilesClient(PersistentAgentsFilesImpl serviceClient) {
