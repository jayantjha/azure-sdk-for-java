...
public final class MessagesImpl {
     ...
     */
    MessagesImpl(AgentsAdministrationClientImpl client) {
    ...
    /**
     * The interface defining all the services for AgentsAdministrationClientMessages to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
