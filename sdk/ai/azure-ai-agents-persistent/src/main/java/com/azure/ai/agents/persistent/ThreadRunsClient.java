...
import com.azure.ai.agents.persistent.implementation.ThreadRunsImpl;
...
/**
 * Initializes a new instance of the synchronous ThreadRuns type.
 */
@ServiceClient(builder = PersistentAgentsClientBuilder.class)
public final class ThreadRunsClient {

    private final ClientLogger logger = new ClientLogger(ThreadRunsClient.class);
