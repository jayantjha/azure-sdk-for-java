...
public final class VectorStoreFilesImpl {
     ...
     */
    VectorStoreFilesImpl(AgentsAdministrationClientImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AgentsAdministrationClientVectorStoreFiles to be used by the proxy
    ...
    public Response<BinaryData> listVectorStoreFilesWithResponse(String vectorStoreId, RequestOptions requestOptions) {
        final String accept = "application/json";
        return service.listVectorStoreFilesSync(this.client.getEndpoint(), this.client.getServiceVersion().getVersion(),
