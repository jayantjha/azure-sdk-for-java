...
/**
 * Initializes a new instance of the asynchronous AgentsAdministrationClient type.
 */
@ServiceClient(builder = AgentsAdministrationClientBuilder.class, isAsync = true)
public final class AgentsAdministrationAsyncClient {

    @Generated
    private final AgentsAdministrationClientImpl serviceClient;

    /**
     * Initializes an instance of AgentsAdministrationAsyncClient class.
     *
     * @param serviceClient the service client implementation.
     */
    @Generated
    AgentsAdministrationAsyncClient(AgentsAdministrationClientImpl serviceClient) {
