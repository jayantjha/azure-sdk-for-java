...
public final class RunsImpl {
     ...
     */
    RunsImpl(AgentsAdministrationClientImpl client) {
    ...
    /**
     * The interface defining all the services for AgentsAdministrationClientRuns to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
