...
public final class RunStepsImpl {
     ...
     */
    private final AgentsAdministrationClientImpl client;
     ...
     */
    RunStepsImpl(AgentsAdministrationClientImpl client) {
    ...
    /**
     * The interface defining all the services for AgentsAdministrationClientRunSteps to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{endpoint}")
