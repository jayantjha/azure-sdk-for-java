...
import com.azure.ai.agents.persistent.implementation.AgentsAdministrationClientImpl;
...
/**
 * A builder for creating a new instance of the AgentsAdministrationClient type.
 */
@ServiceClientBuilder(
    serviceClients = {
        AgentsAdministrationClient.class,
        ThreadsClient.class,
        ...
        AgentsAdministrationAsyncClient.class,
...
public final class AgentsAdministrationClientBuilder implements HttpTrait<AgentsAdministrationClientBuilder>,
    ConfigurationTrait<AgentsAdministrationClientBuilder>, TokenCredentialTrait<AgentsAdministrationClientBuilder>,
    KeyCredentialTrait<AgentsAdministrationClientBuilder>, EndpointTrait<AgentsAdministrationClientBuilder> {
    ...
    /**
     * Create an instance of the AgentsAdministrationClientBuilder.
     */
    @Generated
    public AgentsAdministrationClientBuilder() {
    ...
    @Generated
    @Override
    public AgentsAdministrationClientBuilder pipeline(HttpPipeline pipeline) {
    ...
    @Generated
    @Override
    public AgentsAdministrationClientBuilder httpClient(HttpClient httpClient) {
    ...
    @Generated
    @Override
    public AgentsAdministrationClientBuilder httpLogOptions(HttpLogOptions httpLogOptions) {
    ...
    @Generated
    @Override
    public AgentsAdministrationClientBuilder clientOptions(ClientOptions clientOptions) {
    ...
    @Generated
    @Override
    public AgentsAdministrationClientBuilder retryOptions(RetryOptions retryOptions) {
    ...
    @Generated
    @Override
    public AgentsAdministrationClientBuilder addPolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Generated
    @Override
    public AgentsAdministrationClientBuilder configuration(Configuration configuration) {
    ...
    @Generated
    @Override
    public AgentsAdministrationClientBuilder credential(TokenCredential tokenCredential) {
    ...
    @Generated
    @Override
    public AgentsAdministrationClientBuilder credential(KeyCredential keyCredential) {
    ...
    @Generated
    @Override
    public AgentsAdministrationClientBuilder endpoint(String endpoint) {
     ...
     * @return the AgentsAdministrationClientBuilder.
     */
    @Generated
    public AgentsAdministrationClientBuilder serviceVersion(AgentsServiceVersion serviceVersion) {
     ...
     */
    @Generated
    public AgentsAdministrationClientBuilder retryPolicy(RetryPolicy retryPolicy) {
        this.retryPolicy = retryPolicy;
        return this;
    }

    /**
     * Builds an instance of AgentsAdministrationClientImpl with the provided parameters.
     *
     * @return an instance of AgentsAdministrationClientImpl.
     */
    @Generated
    private AgentsAdministrationClientImpl buildInnerClient() {
        this.validateClient();
        HttpPipeline localPipeline = (pipeline != null) ? pipeline : createHttpPipeline();
        AgentsServiceVersion localServiceVersion
            = (serviceVersion != null) ? serviceVersion : AgentsServiceVersion.getLatest();
        AgentsAdministrationClientImpl client = new AgentsAdministrationClientImpl(localPipeline,
    ...
    /**
     * Builds an instance of AgentsAdministrationAsyncClient class.
     *
     * @return an instance of AgentsAdministrationAsyncClient.
     */
    @Generated
    public AgentsAdministrationAsyncClient buildAsyncClient() {
        return new AgentsAdministrationAsyncClient(buildInnerClient());
    }
    ...
    /**
     * Builds an instance of AgentsAdministrationClient class.
     *
     * @return an instance of AgentsAdministrationClient.
     */
    @Generated
    public AgentsAdministrationClient buildClient() {
        return new AgentsAdministrationClient(buildInnerClient());
    }
    ...
    private static final ClientLogger LOGGER = new ClientLogger(AgentsAdministrationClientBuilder.class);
}
