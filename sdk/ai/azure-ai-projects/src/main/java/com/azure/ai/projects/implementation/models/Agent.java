 ...
 */
@Immutable
public final class Agent implements JsonSerializable<Agent> {
    /*
     ...
     */
    @Generated
    private Agent(String id, OffsetDateTime createdAt, String name, String description, String model,
    ...
    /**
     * Reads an instance of Agent from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of Agent if the JsonReader was pointing to an instance of it, or null if it was pointing to
     * JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the Agent.
     */
    @Generated
    public static Agent fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            Agent deserializedAgent = new Agent(id, createdAt, name, description, model, instructions, tools,
                toolResources, temperature, topP, metadata);
            deserializedAgent.responseFormat = responseFormat;
