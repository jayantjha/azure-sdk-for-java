 ...
 */
@Immutable
public final class BlobReferenceForConsumption implements JsonSerializable<BlobReferenceForConsumption> {
    /*
    ...
    /**
     * Creates an instance of BlobReferenceForConsumption class.
     * 
     ...
     */
    @Generated
    private BlobReferenceForConsumption(String blobUri, String storageAccountArmId, SasCredential credential) {
    ...
    /**
     * Reads an instance of BlobReferenceForConsumption from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of BlobReferenceForConsumption if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the BlobReferenceForConsumption.
     */
    @Generated
    public static BlobReferenceForConsumption fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            return new BlobReferenceForConsumption(blobUri, storageAccountArmId, credential);
        });
    }
}
