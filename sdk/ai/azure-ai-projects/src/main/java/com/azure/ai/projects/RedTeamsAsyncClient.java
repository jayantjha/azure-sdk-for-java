...
public final class RedTeamsAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> createRunWithResponse(BinaryData redTeam, RequestOptions requestOptions) {
        return this.serviceClient.createRunWithResponseAsync(redTeam, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<RedTeam> list(Integer top, Integer skip) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<RedTeam> createRun(RedTeam redTeam) {
        // Generated convenience method for createRunWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return createRunWithResponse(BinaryData.fromObject(redTeam), requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(RedTeam.class));
    }
}
