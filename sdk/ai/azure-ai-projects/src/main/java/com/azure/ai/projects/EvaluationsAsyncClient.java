...
public final class EvaluationsAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> createRunWithResponse(BinaryData evaluation, RequestOptions requestOptions) {
        return this.serviceClient.createRunWithResponseAsync(evaluation, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Evaluation> createRun(Evaluation evaluation) {
        // Generated convenience method for createRunWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return createRunWithResponse(BinaryData.fromObject(evaluation), requestOptions).flatMap(FluxUtil::toMono)
            .map(protocolMethodData -> protocolMethodData.toObject(Evaluation.class));
    }
