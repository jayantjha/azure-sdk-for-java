 ...
 */
@Fluent
public final class AgentThreadCreationOptions implements JsonSerializable<AgentThreadCreationOptions> {
    /*
    ...
    /**
     * Creates an instance of AgentThreadCreationOptions class.
     */
    @Generated
     ...
     * @return the AgentThreadCreationOptions object itself.
     */
    @Generated
    public AgentThreadCreationOptions setMessages(List<ThreadMessageOptions> messages) {
     ...
     */
    @Generated
    public AgentThreadCreationOptions setToolResources(ToolResources toolResources) {
     ...
     */
    @Generated
    public AgentThreadCreationOptions setMetadata(Map<String, String> metadata) {
    ...
    /**
     * Reads an instance of AgentThreadCreationOptions from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of AgentThreadCreationOptions if the JsonReader was pointing to an instance of it, or null if
     * it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the AgentThreadCreationOptions.
     */
    @Generated
    public static AgentThreadCreationOptions fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            AgentThreadCreationOptions deserializedAgentThreadCreationOptions = new AgentThreadCreationOptions();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("messages".equals(fieldName)) {
                    ...
                    deserializedAgentThreadCreationOptions.messages = messages;
                } else if ("tool_resources".equals(fieldName)) {
                    deserializedAgentThreadCreationOptions.toolResources = ToolResources.fromJson(reader);
                } else if ("metadata".equals(fieldName)) {
                    Map<String, String> metadata = reader.readMap(reader1 -> reader1.getString());
                    deserializedAgentThreadCreationOptions.metadata = metadata;
                } else {
                    reader.skipChildren();
                }
            }

            return deserializedAgentThreadCreationOptions;
        });
    }
}
