...
public final class EvaluationsClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> createRunWithResponse(BinaryData evaluation, RequestOptions requestOptions) {
        return this.serviceClient.createRunWithResponse(evaluation, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Evaluation createRun(Evaluation evaluation) {
        // Generated convenience method for createRunWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return createRunWithResponse(BinaryData.fromObject(evaluation), requestOptions).getValue()
