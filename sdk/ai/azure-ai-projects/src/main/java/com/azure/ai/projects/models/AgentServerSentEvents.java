...
import static com.azure.ai.projects.models.AgentStreamEvent.DONE;
import static com.azure.ai.projects.models.AgentStreamEvent.ERROR;

/**
 * A class that handles the deserialization of server sent events.
 */
public final class AgentServerSentEvents {
    ...
    /**
     * Creates a new instance of AgentServerSentEvents.
     *
     * @param source The source of the server sent events.
     */
    public AgentServerSentEvents(Flux<ByteBuffer> source) {
        this.source = source;
