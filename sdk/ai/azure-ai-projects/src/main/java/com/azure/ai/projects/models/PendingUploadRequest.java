...
public final class PendingUploadRequest implements JsonSerializable<PendingUploadRequest> {
    ...
    /**
     * Get the connectionName property: Name of Azure blob storage connection to use for generating temporary SAS token.
     * 
    ...
    /**
     * Set the connectionName property: Name of Azure blob storage connection to use for generating temporary SAS token.
     * 
